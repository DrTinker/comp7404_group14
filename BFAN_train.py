...
from evaluation.evaluation import i2t, t2i, AverageMeter, LogCollector, encode_data, shard_xattn
...
def main():
    ...
    parser.add_argument('--logger_name', default='./models/bfan/log',
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default='./models/bfan/checkpoint',
...
def validate(opt, val_loader, model):
    ...
    (r1, r5, r10, medr, meanr) = i2t(batch_size, sims)
    logging.info("Image to text: %.1f, %.1f, %.1f, %.1f, %.1f" %
                 (r1, r5, r10, medr, meanr))
    # image retrieval
    (r1i, r5i, r10i, medri, meanr) = t2i(batch_size, sims)
